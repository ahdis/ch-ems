...
Invariant: ch-elm-component-code-geno-loinc
Description: "If Observation.code is mapped in http://fhir.ch/ig/ch-elm/ConceptMap/ch-elm-results-geno-to-component-code, then the component.code code must be a member of the mapped ValueSet for genotyping testing"
Severity: #error
...
Invariant: ch-elm-component-code-geno-snomedct
Description: "If Observation.code is mapped in http://fhir.ch/ig/ch-elm/ConceptMap/ch-elm-results-geno-to-component-code, then the component.code code must be a member of the mapped ValueSet for genotyping testing"
Severity: #error
...
Invariant: ch-elm-component-interpretation-code-susc-loinc
Description: "If Observation.code is mapped in http://fhir.ch/ig/ch-elm/ConceptMap/ch-elm-results-susc-to-component-interpretation-code, then the component.code code must be a member of the mapped ValueSet for Susceptibility testing"
Severity: #error
...
Invariant: ch-elm-component-interpretation-code-susc-snomedct
Description: "If Observation.code is mapped in http://fhir.ch/ig/ch-elm/ConceptMap/ch-elm-results-susc-to-component-interpretation-code, then the component.code code must be a member of the mapped ValueSet for Susceptibility testing"
Severity: #error
