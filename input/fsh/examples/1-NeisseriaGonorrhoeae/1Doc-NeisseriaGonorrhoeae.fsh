...
* entry[ServiceRequest][=].resource = 1SR-Order2-PrimaryLab
...
* entry[Organization][+].fullUrl = "http://test.fhir.ch/r4/Organization/1Org-SuperLabor"
* entry[Organization][=].resource = 1Org-SuperLabor
