Instance: 51bDoc-Susceptibility
InstanceOf: ChElmDocument // ChElmDocumentStrict
Usage: #example
Title: "51bDoc - Susceptibility: Variant with 'component'"
Description: "Example for a CH ELM Document: Laboratory Report"
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:uuid:7bb4d082-a40f-4771-b062-2851bf2f7b7de"
* type = #document
* timestamp = "2023-09-10T12:00:00+02:00"
* entry[0].fullUrl = "http://test.fhir.ch/r4/Composition/51bComp-Susceptibility"
* entry[=].resource = 51bComp-Susceptibility
* entry[+].fullUrl = "http://test.fhir.ch/r4/DiagnosticReport/51bDR-Susceptibility"
* entry[=].resource = 51bDR-Susceptibility
* entry[+].fullUrl = "http://test.fhir.ch/r4/Patient/Pat-001"
* entry[=].resource = Pat-001
* entry[+].fullUrl = "http://test.fhir.ch/r4/Observation/51bObs-Susceptibility"
* entry[=].resource = 51bObs-Susceptibility
* entry[+].fullUrl = "http://test.fhir.ch/r4/Specimen/51bSpec-Susceptibility"
* entry[=].resource = 51bSpec-Susceptibility
* entry[+].fullUrl = "http://test.fhir.ch/r4/ServiceRequest/51bSR-Susceptibility"
* entry[=].resource = 51bSR-Susceptibility
...
Instance: 51bComp-Susceptibility
...
* section.entry = Reference(51bObs-Susceptibility)

Instance: 51bDR-Susceptibility
...
* extension[DiagnosticReportCompositionR5].valueReference = Reference(Composition/51bComp-Susceptibility)
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:uuid:7bb4d082-a40f-4771-b062-2851bf2f7b7de"
* basedOn = Reference(51bSR-Susceptibility)
* status = #final
* code = $loinc#11502-2 "Laboratory report"
* subject = Reference(Pat-001)
* performer = Reference(1Org-Labor)
* specimen = Reference(51bSpec-Susceptibility)
* result = Reference(51bObs-Susceptibility)

Instance: 51bSR-Susceptibility
...
Instance: 51bSpec-Susceptibility
...
Instance: 51bObs-Susceptibility
...
* component[0].code = $loinc#20381-0 "Ethambutol [Susceptibility] by Method for Slow-growing mycobacteria"
...
* component[+].code = $loinc#20383-6 "Isoniazid [Susceptibility] by Method for Slow-growing mycobacteria"
...
* component[+].code = $loinc#20462-8 "Streptomycin [Susceptibility] by Method for Slow-growing mycobacteria"
* component[=].valueQuantity = 20 'mg/L' "milligram per liter"
* component[=].interpretation = $v3-ObservationInterpretation#S "Susceptible" // #R "Resistant" | #S "Susceptible"
