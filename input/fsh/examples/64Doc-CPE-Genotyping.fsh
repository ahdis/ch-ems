...
* component[=].interpretation.text = "absent" // TBD: new interpretation codes ???

// * component[0].code.text = "some code for «Generic CPE mutation» (TBD)"  // TBD: used as string
// * component[=].valueString = "some mutation string" // TBD: new interpretation codes ???
// we need either value or dataAbsentReasen: Bundle.entry[3].resource/*Observation/64Obs-Genotyping*/: Constraint failed: eu-lab-2: 'If observation has components and observation status is other then "registered" or "cancelled", at least one of these Observation.component elements shall be provided: "value" or "dataAbsentReason"' (defined in http://hl7.eu/fhir/laboratory/StructureDefinition/Observation-resultslab-eu-lab)