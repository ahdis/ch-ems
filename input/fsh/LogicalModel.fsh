...
* Patient.OASI 1..1 Identifier "Old-age and survivors's insurance (OASI) number"
...
* Orderer.OrganizationGLN -> "Bundle.entry.resource.as(DiagnosticReport).basedOn.resolve().requester.resolve().organization.resolve().identifier.where(system='urn:oid:2.51.1.3').value"
...
* Orderer.OrganizationAddress.StreetLine -> "Bundle.entry.resource.as(DiagnosticReport).basedOn.resolve().requester.resolve().organization.resolve().address.line[0]"
* Orderer.OrganizationAddress.PostBox -> "Bundle.entry.resource.as(DiagnosticReport).basedOn.resolve().requester.resolve().organization.resolve().address.line[1]"
...
* Patient.OASI -> "Bundle.entry[0].resource.subject.resolve().identifier.where(system='urn:oid:2.16.756.5.32').value"
...
* TestResult.StudyType -> "Bundle.entry[0].resource.section.code.coding"
* TestResult.ExecutionDateTime -> "Bundle.entry[0].resource.section.entry.resolve().effective"
* TestResult.Type -> "Bundle.entry[0].resource.section.entry.resolve().code"
* TestResult.Type.Code -> "Bundle.entry[0].resource.section.entry.resolve().code.coding.code"
* TestResult.Type.CodeSystem -> "Bundle.entry[0].resource.section.entry.resolve().code.coding.system"
...
* TestResult.Specimen.Type.Code -> "Bundle.entry[0].resource.section.entry.resolve().specimen.resolve().type.coding.code"
* TestResult.Specimen.Type.CodeSystem -> "Bundle.entry[0].resource.section.entry.resolve().specimen.resolve().type.coding.system"
