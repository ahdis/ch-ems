...
* Patient.PatientSexCode -> "Bundle.entry[0].resource.subject.resolve().gender"
...
* Patient.PatientAddress.PatientCountryCode -> "TODO" // "Bundle.entry[0].resource.subject.resolve().address.country.extension.where(url='http://hl7.org/fhir/StructureDefinition/iso21090-SC-coding').valueCoding.code"
